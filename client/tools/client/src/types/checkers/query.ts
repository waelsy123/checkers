...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("waelsy123.checkers.checkers.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  SystemInfo(request: QueryGetSystemInfoRequest = {}): Promise<QueryGetSystemInfoResponse> {
    const data = QueryGetSystemInfoRequest.encode(request).finish();
    const promise = this.rpc.request("waelsy123.checkers.checkers.Query", "SystemInfo", data);
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request("waelsy123.checkers.checkers.Query", "StoredGame", data);
  ...
  StoredGameAll(request: QueryAllStoredGameRequest = {
    ...
    const promise = this.rpc.request("waelsy123.checkers.checkers.Query", "StoredGameAll", data);
  ...
  CanPlayMove(request: QueryCanPlayMoveRequest): Promise<QueryCanPlayMoveResponse> {
    ...
    const promise = this.rpc.request("waelsy123.checkers.checkers.Query", "CanPlayMove", data);
